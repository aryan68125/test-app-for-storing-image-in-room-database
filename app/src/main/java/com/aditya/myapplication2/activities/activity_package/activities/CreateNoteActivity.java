package com.aditya.myapplication2.activities.activity_package.activities;
...
import com.aditya.myapplication2.activities.activity_package.database.NotesDatabase;
...
public class CreateNoteActivity extends AppCompatActivity {
    ...
    //handling saving images in the database not image path
    ...
    private void saveNote()
    {
        ...
        //here save the byte in the column image of byte array
        note.setImage(imagebyte);
            ...
            if(data!= null)
            {
                ...
                if(selectedImageUri !=null)
                {
                    try {
                        ...
                        imageNote.setImageBitmap(bitmap); //setting image to imageNote in createNote xml file
                        imageNote.setVisibility(View.VISIBLE);
                        //getting the path of the selected image file
                        selectedImagePath = getPathFromUri(selectedImageUri);
                        findViewById(R.id.imageRemoveImage).setVisibility(View.VISIBLE);

                        //convert the selected image from bitmap to byte array
                        imagebyte = ImageBitmapString.BitMapToByteArray(bitmap);
                    }
                    catch (Exception e)
                    {
    ...
    private void setViewOrUpdateNote()
    {
        ...
        //getting image path from the database
        /*
...
*/
        //getting image blob from the database and setting it the the image view
        if(alreadyAvailableNote.getImagePath()!= null && !alreadyAvailableNote.getImagePath().trim().isEmpty())
        {
            try {
                selectedImagePath = alreadyAvailableNote.getImagePath();

                //IF YOU don't refresh image blob via image path that is stored in the database then your stored image will
                // become null when the database is refreshed during update of the note
                //....................REFRESHING IMAGE BLOB IN THE ROOM DATABASE START...........................//
                Bitmap refreshImageBitmap = BitmapFactory.decodeFile(alreadyAvailableNote.getImagePath());
                //convert the selected image from bitmap to byte array
                imagebyte = ImageBitmapString.BitMapToByteArray(refreshImageBitmap);
                alreadyAvailableNote.setImage(imagebyte);
                //....................REFRESHING IMAGE BLOB IN THE ROOM DATABASE END...........................//
                ...
                //bitmapImage stores the refreshed image data
                bitmapImage = ImageBitmapString.ByteArrayToBitMap(alreadyAvailableNote.getImage());
                Log.i("bitmapFrom database",bitmapImage.toString());
